...
def test_topic_avatar_upload(gl, fixture_dir):
    ...
    topic = gl.topics.create({"name": "avatar-topic", "description": "Topic with avatar", "title": "Avatar Topic"})
...
def test_topic_avatar_remove(gl, fixture_dir):
    ...
    topic = gl.topics.create({"name": "avatar-topic-remove", "description": "Remove avatar", "title": "Remove Avatar"})
